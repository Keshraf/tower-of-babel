...
export async function speakFrench(text: string): Promise<void> {
  ...
  utterance.rate = 0.9; // Slightly slower for more natural rhythm
...
/**
 * Optional: Stop any currently playing speech
 */
...
/**
 * Optional: Get all available French voices for user selection
 */
